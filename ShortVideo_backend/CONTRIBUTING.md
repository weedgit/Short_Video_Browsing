...
- `feat/phase-2-auth-api`
- `feat/feed-cursor-pagination`
- `fix/health-ready-status-code`
- `fix/env-validation-optional-db`
...
```text
feat: add POST /v1/auth/login endpoint
fix: return 503 only when dependency is down
```
